...
Each ranked file includes current path, previous path for renames, status, score, level, classification fields, line counts, related signal IDs, applied factors, and limitations.
...
Version `v1` uses five capped factor groups:
...
- `change_size`: capped at 15 points. Changed-line thresholds are 50, 200, 500, and 1000 lines.
